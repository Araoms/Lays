...
<table class="table">
				...
				<tr>
					...
					<a href="http://www.lays.vip/upload/wx001.jpg" data-toggle="lightbox" class="btn btn-info">图一</a>
										<a href="http://www.lays.vip/upload/wx002.jpg" data-toggle="lightbox" class="btn btn-info">图二</a>
					</td>
...
<form action="index.php?admin_weixin/savetoken{$setting['seo_suffix']}" method="post" onsubmit="return checktoken();">
			<table class="table">
				<tr class="header">
					<td colspan="2" class="text-danger font-15">开发者模式设置，配置需开启开发者模式<a href="http://www.lays.vip/css/images/tokensetting.png" data-toggle="lightbox" class="btn btn-info">查看详情</a></td>
				</tr>
				<tr>
...
<hr>
<a class="btn btn-success" target="_blank" href="https://www.lays.vip/article-14581.html">查看微信公众号配置教程</a>
<a style="margin-left: 20px;" class="btn btn-success" target="_blank" href="https://www.lays.vip/article-14934.html">查看微信支付配置教程</a>
