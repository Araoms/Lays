...
INSERT INTO `whatsns_category` VALUES (1,'默认分类','',0,1,1,36,'默认分类别名','',0,'','catlist','topicone',0,1,1,1,1);
...
INSERT INTO `whatsns_link` VALUES (2,0,'问答系统','https://www.whatsns.com/','问答系统',''),(3,0,'whatsns开源社区','https://www.lays.vip/','php开源问答系统','');
