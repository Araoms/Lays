...
<form action="index.php?admin_setting/seo{$setting['seo_suffix']}" method="post">
    ...
    <table class="table">
        ...
        <tr>
            <td class="altbg1" width="45%"><b>页面地址后缀:</b><br><span class="smalltxt">不建议修改本参数，此参数目的是为了防止服务器全局rewrite开启，影响Lays的访问</span></td>
    ...
    <table cellspacing="1" cellpadding="4" width="100%" align="center" class="tableborder">
        <tr class="header">
         ...
         <tr>
            <td width="45%"><b>百度推送的api地址:</b><br><span class="smalltxt">百度站长后台链接提交里的api地址，<a href="http://www.lays.vip/upload/ff.png" data-toggle="lightbox" class="btn btn-primary">详情请点击这查图片所示位置</a></span></td>
