...
<table class="table">
	<tbody><tr class="header"><td>设置说明</td></tr>
            <tr class="altbg1"><td>UCenter整合开启前，务必关闭通行证整合。<br />配置步骤如下：<br />1、ucenter服务端添加Lays问答应用<br />2、添加完成之后将生成的应用配置贴到下方即可<br />3、ucenter服务端检测Lays问答连接状态，通信成功即表示整合完成</td></tr>
</tbody></table>
<br />
...
<form action="index.php?admin_setting/ucenter{$setting['seo_suffix']}" method="post">
	...
	<table class="table">
		...
		<tr>
			<td class="altbg1" width="45%"><b>论坛UCenter地址</b><br><span class="smalltxt">填写uc中的uc_api,也就是你论坛ucenter的地址<a href="http://www.lays.vip/upload/dzucapi.jpg" data-toggle="lightbox" class="btn btn-danger">查看在哪复制</a></span></td>
	...
	<br>
	<p style="text-align:center;"><a target="_blank" style="color:red;font-weight:700;" href="https://www.lays.vip/topic/getone/14829.html">配置之前先读下这篇问答【慎重配置】</a></p>
