...
<link rel="stylesheet" media="all" href="{SITE_URL}static/css/widescreen/css/widescreendetail.css?v1.1" />
  ...
  {/if}
	...
	<script>
        ...
        <a class="share-circle" data-toggle="tooltip" href="javascript:void((function(s,d,e,r,l,p,t,z,c){var%20f='http://v.t.sina.com.cn/share/share.php?appkey=1515056452',u=z||d.location,p=['&amp;url=',e(u),'&amp;title=',e(t||d.title),'&amp;source=',e(r),'&amp;sourceUrl=',e(l),'&amp;content=',c||'gb2312','&amp;pic=',e(p||'')].join('');function%20a(){if(!window.open([f,p].join(''),'mb',['toolbar=0,status=0,resizable=1,width=440,height=430,left=',(s.width-440)/2,',top=',(s.height-430)/2].join('')))u.href=[f,p].join('');};if(/Firefox/.test(navigator.userAgent))setTimeout(a,0);else%20a();})(screen,document,encodeURIComponent,'','','{$setting['site_logo']}', '推荐 {$question['author_2']} 的问题《{$question['title']}》','{url question/view/$question[id]}','页面编码gb2312|utf-8默认gb2312'));" data-original-title="分享到微博" >
  ...
  <script type="text/javascript">document.write(['<a class="share-circle" data-toggle="tooltip"  target="_self" data-original-title="分享到qq空间" href="http://sns.qzone.qq.com/cgi-bin/qzshare/cgi_qzshare_onekey?url=',encodeURIComponent(location.href),'&title=',encodeURIComponent(document.title),'" target="_self"   title="分享到QQ空间" target="_blank"> <i class="fa fa-qq"></i><\/a>'].join(''));</script>
...
<div class="top-author-card follow-box col-md-8">
    <div class="card-designer-list-details details-right-author-wrap card-media">
        ...
        <div class="avatar-container-80">
            ...
            <a href="{url user/space/$question['authorid']}"  class="avatar" target="_blank">
        ...
        <div class="author-info">
            <p class="author-info-title">
             {if $question['hidden']!=1}
                ...
                <a href="{url user/space/$question['authorid']}" class="title-content" target="_blank">
              {$question['author']}
      ...
      {if $question['description']}
            <div class="show-content shortquestioncontent">
                ...
                {if $question['artlen']>=120||strstr($question['shortdescription'],'图')}
...
<div id="comment-list" class="comment-list bb" style="margin:0px;margin-bottom:20px;{if $question['answers']==0}display:none;{/if}">
                             ...
                             {eval    echo replacewords($bestanswer['content']);    }
                               ...
                               {if $bestanswer['canview']==0}
                                 <div class="box_toukan ">
											...
											{if $user['uid']==0}
											<div onclick="login()" data-placement="bottom" title="" data-toggle="tooltip" data-original-title="我也付费偷偷看" class="thiefbox font-12" onclick=""><i class="icon icon-lock font-12"></i> &nbsp;精彩回答&nbsp;$bestanswer['reward']&nbsp;&nbsp;元偷偷看…… <span class="kanguoperson">$bestanswer['viewnum']人看过</span></div>
											{else}
											<div onclick="viewanswer($bestanswer['id'])" data-placement="bottom" title="" data-toggle="tooltip" data-original-title="我也付费偷偷看" class="thiefbox font-12" onclick=""><i class="icon icon-lock font-12"></i> &nbsp;精彩回答&nbsp;$bestanswer['reward']&nbsp;&nbsp;元偷偷看……<span class="kanguoperson">$bestanswer['viewnum']人看过</span></div>
											{/if}
    ...
    <source src="{SITE_URL}data/weixinrecord/{$bestanswer['mediafile']}" type="audio/mpeg" />
           ...
           <a data-placement="bottom" title="" data-toggle="tooltip" data-original-title="继续回答问题" href="{url answer/append/$question['id']/$bestanswer['id']}"><i class="fa fa-file-powerpoint-o"></i> <span>追问</span></a>
               ...
               <!--{/if}-->
             {if $setting['openwxpay']==1}
        <a class="shangke " data-placement="bottom" title="" data-toggle="tooltip" {if $bestanswer['total']==0} data-original-title="任意打赏Ta" {else} data-original-title="已获得网友$bestanswer['total']元赏金" {/if} onclick="wxpay('aid',{$bestanswer['id']},{$bestanswer['authorid']} );"><i class="fa fa-hongbao color-white"></i></a>
                {/if}
                             ...
                             {eval    echo replacewords($answer['content']);    }
                               ...
                               {if $answer['canview']==0}
                                 <div class="box_toukan ">
											...
											{if $user['uid']==0}
											<div onclick="login()" data-placement="bottom" title="" data-toggle="tooltip" data-original-title="我也付费偷偷看" class="thiefbox font-12" onclick=""><i class="icon icon-lock font-12"></i> &nbsp;精彩回答&nbsp;$answer['reward']&nbsp;&nbsp;元偷偷看……{if $answer['viewnum']>0}<span class="kanguoperson">$answer['viewnum']人看过{/if}</span></div>
											{else}
											<div onclick="viewanswer($answer['id'])" data-placement="bottom" title="" data-toggle="tooltip" data-original-title="我也付费偷偷看" class="thiefbox font-12" onclick=""><i class="icon icon-lock font-12"></i> &nbsp;精彩回答&nbsp;$answer['reward']&nbsp;&nbsp;元偷偷看……{if $answer['viewnum']>0}<span class="kanguoperson">$answer['viewnum']人看过{/if}</span></div>
											{/if}
    ...
    <source src="{SITE_URL}data/weixinrecord/{$answer['mediafile']}" type="audio/mpeg" />
         ...
         <!--{if 1==$user['grouptype'] ||$user['uid']==$question['authorid']}-->
                             ...
                             <!--{/if}-->
                      {if $setting['openwxpay']==1}
                <a class="shangke " data-placement="bottom" title="" data-toggle="tooltip" {if $answer['total']==0} data-original-title="任意打赏Ta" {else} data-original-title="已获得网友$answer['total']元赏金" {/if} onclick="wxpay('aid',{$answer['id']},{$answer['authorid']} );"><i class="fa fa-hongbao"></i> </a>
                {/if}
                <!--{if 1==$user['grouptype'] ||$user['uid']==$answer['authorid']}-->
