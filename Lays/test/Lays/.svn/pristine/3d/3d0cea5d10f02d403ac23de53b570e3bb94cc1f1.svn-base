...
<li class=""><a href="{url user/record}"><i class="fa fa-tasks"></i>做题记录</a></li>
 </ul>
...
<li class="tagPopup authorinfo">
    ...
    <!--{/loop}-->
      ...
      <!--{else}-->
       <div class="text">
          <p>   <span>亲，快设置下擅长领域吧，设置后可根据您的兴趣爱好为您推荐合适的问题!</span><a class="btn "
                                                                  href="{url user/mycategory}">点击设置擅长领域</a></p>
          </div>
          <!--{/if}-->
