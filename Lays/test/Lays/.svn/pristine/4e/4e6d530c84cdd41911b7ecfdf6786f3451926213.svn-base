...
<form {if isset($curnav)}action="index.php?admin_nav/edit{$setting['seo_suffix']}"{else}action="index.php?admin_nav/add{$setting['seo_suffix']}"{/if} method="post">
    <table  class="table table-striped">
        ...
        <tr>
            <td class="altbg1" width="45%"><b>URL地址:</b><br><span class="smalltxt">导航的链接地址，如果ask2系统外的网址，请输入全网址。如:http://www.lays.vip</span></td>
            <td class="altbg2"><input class="txt"  name="url" style="width:300px;" {if isset($curnav['url'])}value="{$curnav['url']}" {/if} /></td>
        </tr>
        <tr style="display:none">
            <td class="altbg1" width="45%"><b>导航类型:</b><br><span class="smalltxt">导航的链接地址，如果ask2系统外的网址，请输入全网址。如:http://www.lays.vip</span></td>
            <td class="altbg2">
                <div class="col-md-2">
