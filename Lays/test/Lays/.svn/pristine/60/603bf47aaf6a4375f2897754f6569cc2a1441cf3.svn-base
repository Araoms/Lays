...
<head>
  ...
  <title>微信测试</title>
    <link href="http://www.lays.vip/css/dist/css/zui.min.css" rel="stylesheet">

 <link rel="stylesheet" href="http://demo.open.weixin.qq.com/jssdk/css/style.css?ts=1420774989">
    <link href="http://www.lays.vip/css/dist/css/main.css" rel="stylesheet">
    <!-- jQuery -->
<script src="http://www.lays.vip/js/jquery-1.11.3.min.js" type="text/javascript"></script>
