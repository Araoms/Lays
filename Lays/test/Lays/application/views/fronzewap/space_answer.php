...
<section class="my-favorite back-f">
	...
	<section class="questions back-f">
		<textarea placeholder="指定该答题者答题，如果专家设置答案查看付费，扣除平台分成外，默认您将和答题者平分此回答偷看金额，如果答题者未在规定时间内回答问题，付费金额将退回给提问者。" id="quicktitle" maxlength="80"></textarea>
	...
	<h4 class="pl">
         ...
         <div class="l_title"><h2><a href="{url question/answer/$question['qid']/$question['id']}">
 ...
 {else}
  ...
  {/if}
     ...
     <div class="ask-bottom">
          ...
          <a href="{url question/answer/$question['qid']/$question['id']}" class="" ><i class="fa fa-commentingicon"></i>{$question['comments']} 评论</a>
          <a href="{url question/answer/$question['qid']/$question['id']}"  class=" ">{$question['supports']}个赞</a>
     </div>
       </div>
