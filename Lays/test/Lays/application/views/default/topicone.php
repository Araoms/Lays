            ...
            <div class="top-author-card follow-box col-md-8">
                <div class="card-designer-list-details details-right-author-wrap card-media">
                    ...
                    <div class="avatar-container-80">
                        <a href="{url user/space/$member['uid']}" title="{$topicone['author_2']}" class="avatar" >
                    ...
                    <div class="author-info">
                        <p class="author-info-title">
                            ...
                            <a href="{url user/space/$member['uid']}" title="{$topicone['author_2']}" class="title-content">
                                {$topicone['author']}
