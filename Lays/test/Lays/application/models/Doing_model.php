...
// 					}
					...
					$doing ['description'] = clearhtml ( checkwordsglobal ( strip_tags ( $doing ['question'] ['description'] ) ), 120 );
					$doing ['url'] = urlmap ( 'question/view/' . $doing ['questionid'], 2 );
					break;
				...
				case '9' : // 发布了文章
					...
					if( $doing ['topic'] ['readmode']!=1){
						$doing ['description'] = clearhtml ( checkwordsglobal ( strip_tags ( $doing ['topic'] ['freeconent'] ) ), 120 );
						
					}else{
						$doing ['description'] = clearhtml ( checkwordsglobal ( strip_tags ( $doing ['topic'] ['describtion'] ) ), 120 );
