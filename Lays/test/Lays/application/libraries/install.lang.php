...
$lang = array(
	...
	'tips_ask_comment' => 'ask 是 Comsenz 公司产品的核心服务程序，Discuz! Board 的安装和运行依赖此程序。如果您已经安装了 ask，请填写以下信息。否则，请到 <a href="http://www.lays.vip/" target="blank">Comsenz 产品中心</a> 下载并且安装，然后再继续。',
	...
	'uc_version_incorrect' => '您的ask2问答系统服务端版本过低，请升级ask2问答系统服务端到最新版本，并且升级，下载地址：http://www.lays.vip/ 。',
...
<p>ask2软件开发工作室为ask2问答产品的开发商，依法独立拥有ask2问答系统著作权。ask2软件开发工作室网址为 http://www.lays.vip</p>
...
<h3>II. 协议规定的约束和限制</h3>
<ol>
<li>未获商业授权之前，不得将本软件用于商业用途（包括但不限于企业网站、经营性网站、以营利为目或实现盈利的网站）。购买商业授权请登陆http://www.lays.vip参考相关说明，也可以致电15911179271了解详情。</li>
<li>不得对本软件或与之关联的商业授权进行出租、出售、抵押或发放子许可证。</li>
<li>无论如何，即无论用途如何、是否经过修改或美化、修改程度如何，只要使用ask2答系统的整体或任何部分，未经书面许可，页面页脚处的ask2问答系统名称和ask2软件开发工作室下属网站（http://www.lays.vip ） 的链接都必须保留，而不能清除或修改。</li>
