...
//    $contents = file_get_contents($url,FILE_USE_INCLUDE_PATH);
    ...
    $contents = PhantomJs($url);
    file_put_contents('text.txt',$contents.PHP_EOL,FILE_APPEND);
...
function PhantomJs($url){


    $ql = QueryList::getInstance();
// Set PhantomJS bin path
    $ql->use(PhantomJs::class,FCPATH.'/plugin/phantomjs/bin');
//or Custom function name
    $ql->use(PhantomJs::class,FCPATH.'/plugin/phantomjs/bin','browser');

    if(DIRECTORY_SEPARATOR=='\\'){
        $ql->use(PhantomJs::class,FCPATH.'/plugin/phantomjs/bin/phantomjs.exe');
    }else{
        $ql->use(PhantomJs::class,FCPATH.'/plugin/phantomjs/bin/phantomjs');
    }
    return $html = $ql->browser($url)->getHtml();
}
