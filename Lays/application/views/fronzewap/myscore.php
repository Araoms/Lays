  ...
  <div class="usertoolist">
   <div class="weui-flex toolitem">
    <div class="myicon"><i class="fa fa-heart-o" style="top:0px"></i></div>
     <div class="weui-flex__item text">
            <a href="{url user/attention/question}"> 我的关注</a>
     </div>
      <div><i class="icon_jinru"></i></div>
 </div>
 <div class="weui-flex toolitem">
...
if(navigator.userAgent.match('app/whatsns')){
	$(".toolapp").show();
	
}
function clearcache(){
    	  var parmstr=encodeURI("operate#p#clearcache");
	window.location="whatsns://webview?params="+parmstr;
}
