     ...
     <option  {if $caiji['huidashijian']==30} selected  {/if} value="30">30</option>
       ...
       <tr>
        ...
        <tr>
            ...
            <td class="altbg2">
                <textarea id="content" rows="10" cols="80">{$caiji['content']}</textarea>
            </td>
        </tr>
    </table>
	 ...
	 data.caiji_url=caiji_url;
	  ...
	  selectcate();
		...
		// alert('bianma'+bianma);
         ...
         var content=$("#content").val();//过滤掉的内容
	...
	var imgckabox=document.getElementById("imgckabox");//文章过滤img标签
  	 ...
  	 var myurl=g_site_url+"index.php?admin_autocaiji/getarticle{$setting['seo_suffix']}";
  	  $.ajax({
  		    ...
  		    async:false,
  		    dataType:"json",
            data:{'daanurl':dananurl,'guize':guize,'bianma':bianma,'daandesc':daandesc,'daanyuming':daanyuming,'imgckabox':imgckabox.checked,'ckabox':ckabox.checked,'content':content},
