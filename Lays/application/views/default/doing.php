  ...
  <!--首页推荐-->
             ...
             <ul class="nav  mar-t-1 doinglist">
                ...
                <li class="b-b-line mar-t-1 ">
                    ...
                    <div class="col-sm-20">
                      <div class="row">
                        <div class="col-md-3">
                         <a class="image-link" href="{url user/space/$recommanduser['uid']}" target="_blank"><img width="35" height="35" class="img-rounded" alt="{$recommanduser['username_2']}" src="{$recommanduser['avatar']}" /></a>
                ...
                <li class="b-b-line mar-t-1">
                    <div class="row">
                       <div class="col-sm-1">
                        ...
                        <!--{else}-->
                        <a class="pic" target="_blank" title="{$doing['author_2']}" href="{url user/space/$doing['authorid']}"><img width="40" height="40" class="img-rounded" src="{$doing['avatar']}" alt="{$doing['author_2']}" onmouseover="pop_user_on(this, '{$doing[authorid]}', 'img');"  onmouseout="pop_user_out();" /></a>
                        <!--{/if}-->
                    </div>
                        ...
                        <div class="source">
                            ...
                            匿名
                            <!--{else}-->
                            <a title="{$doing['author_2']}"  target="_blank" href="{url user/space/$doing['authorid']}">{$doing['author']}</a>
                            <!--{/if}-->
                        ...
                        <div class="quote bg-silver">
                          <div class="row mar-t-05">
                            <div class="col-sm-4">
                            <div class="avatar ">
                                <a href="{url user/space/$doing['refer_authorid']}"  target="_blank" class="pic"><img width="40" height="40" class="img-rounded" alt="{$doing['author_2']}" src="{$doing['refer_avatar']}" onmouseover="pop_user_on(this, '{$doing['refer_authorid']}', 'img');"  onmouseout="pop_user_out();" /></a>
                            </div>
                            </div>
                            <div class="col-sm-20">
   ...
   <span class="title_text">热门用户</span>
       ...
       <ul class="list ">
                ...
                <div class="row">
                <div class="col-xs-2">
                 <div class="pic mar-t-05"><a title="{$activeuser['username_2']}" target="_blank" href="{url user/space/$activeuser['uid']}"><img style="width:35px;hegiht:35px;" class="img-rounded" alt="{$activeuser['username_2']}" src="{$activeuser['avatar']}" /></a></div>
                </div>
                <div class="col-xs-16">
                <a title="{$activeuser['username_2']}" target="_blank" href="{url user/space/$activeuser['uid']}" >{$activeuser['username']}</a>
