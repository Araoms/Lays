...
-->
 ...
 <label for="" class="control-label col-sm-4">私信权限</label><div class="col-md-20"><div><label class="radio-inline"><input type="radio" name="inbox_permission" value="0" {if $usernotify['inbox_permission']==0}checked=""{/if}>
                        允许所有人给我发私信
                        ...
                        只允许我关注的人给我发私信
                    </label></div></div></div><div class="form-group col-md-20 mt15"><label for="" class="control-label col-sm-4">邀请回答权限</label><div class="col-md-20"><div><label class="radio-inline"><input type="radio" name="invite_permission" value="0"  {if $usernotify['invite_permission']==0}checked=""{/if}>
                        允许所有人邀请我回答
